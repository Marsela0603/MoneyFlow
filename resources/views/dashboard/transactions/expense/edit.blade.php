<x-layout>
    <x-slot name="page_name">Edit Expense</x-slot>
            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('transactions.expense.update', $transaction->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            ...
                            <button type="submit" class="btn btn-primary"><i class="bi bi-save"></i> Update Expense</button>

<x-layout>
    ...
    <x-slot name="navbar">
        ...
        <li class="breadcrumb-item active">Form Jenis Kendaraan</li>
    </x-slot>

    <x-slot name="page_content">
        <div class="card">
            <div class="card-body">
                <h5 class="card-title">Form Jenis Kendaraan</h5>

                <!-- General Form Elements -->
                <form action="{{ url('/dashboard/jenis_kendaraan/store') }}" method="post">
                    @csrf
                    <div class="row mb-3">

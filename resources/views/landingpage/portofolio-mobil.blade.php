        ...
        <div class="row gy-4">
            ...
            <div class="portfolio-details-slider swiper init-swiper">
              ...
              <div class="swiper-wrapper align-items-center">
                ...
                <div class="swiper-slide">
                  <img src="{{asset('welcome/img/portfolio/mobil-1.webp')}}" alt="">
                </div>

                <div class="swiper-slide">
                  <img src="{{asset('welcome/img/portfolio/mobil-2.webp')}}" alt="">
                </div>

                <div class="swiper-slide">
                    <img src="{{asset('welcome/img/portfolio/mobil-3.webp')}}" alt="">
                  </div>
  
                  <div class="swiper-slide">
                    <img src="{{asset('welcome/img/portfolio/mobil-4.webp')}}" alt="">
                  </div>

                  <div class="swiper-slide">
                    <img src="{{asset('welcome/img/portfolio/mobil-5.webp')}}" alt="">
                  </div>
  
                  <div class="swiper-slide">
                    <img src="{{asset('welcome/img/portfolio/mobil-6.webp')}}" alt="">
                  </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info" data-aos="fade-up" data-aos-delay="200">
              ...
              <ul>
                <li><strong>Armada</strong>: Mobil</li>
                <li><strong>Merek</strong>: Toyota, Daihatsu, Suzuki, Pirux, Lexus</li>
              </ul>
            </div>
            <div class="portfolio-description" data-aos="fade-up" data-aos-delay="300">
              <h2>Deskripsi Poduk</h2>
              <p>
                Kendaraan serba guna yang cocok untuk kebutuhan sehari-hari dengan berbagai pilihan merk dan model
              </p>
            </div>
          </div>

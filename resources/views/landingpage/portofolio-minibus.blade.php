        ...
        <div class="row gy-4">
            ...
            <div class="portfolio-details-slider swiper init-swiper">
              ...
              <div class="swiper-wrapper align-items-center">
                ...
                <div class="swiper-slide">
                  <img src="{{asset('welcome/img/portfolio/Minibus-1.png')}}" alt="">
                </div>

                <div class="swiper-slide">
                  <img src="{{asset('welcome/img/portfolio/Minibus-2.png')}}" alt="">
                </div>

                <div class="swiper-slide">
                    <img src="{{asset('welcome/img/portfolio/minibus-3.png')}}" alt="">
                </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info" data-aos="fade-up" data-aos-delay="200">
              ...
              <ul>
                <li><strong>Armada</strong>: Minibus</li>
                <li><strong>Jenis</strong>: Elf Long, Elf Short, Hiace</li>
              </ul>
            </div>
            <div class="portfolio-description" data-aos="fade-up" data-aos-delay="300">
              <h2>Deskripsi Poduk</h2>
              <p>
                Solusi sempurna untuk perjalanan keluarga atau kelompok kecil, menawarkan kenyamanan dan ruang yang memadai
            </div>
          </div>

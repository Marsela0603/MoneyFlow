      ...
      <div class="container">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-6 about-images" data-aos="fade-up" data-aos-delay="200">
            <div class="row gy-4">
              <div class="col-lg-6">
                <img src="{{ asset('assets/img/about/business-3.png') }}" class="img-fluid" alt="">
              </div>
              <div class="col-lg-6">
                <div class="row gy-4">
                  <div class="col-lg-12">
                    <img src="{{ asset('assets/img/about/business.png') }}" class="img-fluid" alt="">
                  </div>
                  <div class="col-lg-12">
                    <img src="{{ asset('assets/img/about/business-2.png') }}" class="img-fluid" alt="">
                  </div>
                </div>
              </div>
            </div>
